...
clear;
close all;
s=audioread('Sweep_Channel_1.wav'); 		%Sinyal ESS yang dibangkitkan diruanagan
s=s';
[s_hall,fs]=audioread('Track_2_007.wav'); 	%Sinyal ESS terekam pada ruangan
s_hall=s_hall';
sinv=audioread('Inverse_Filter.wav'); 		%Sinyal invers ESS
sinv=sinv';
