...
N=4; %Total number of elements the dense ULA 
...
%plotresponse(x64,fc,c,'RespCut','Az','Format','Polar');
...
% % tambahan
% hdoa=phased.BeamscanEstimator('SensorArray',ULA64,...
%    'PropagationSpeed',c,'OperatingFrequency',fc,...
%    'DOAOutputPort',true,'NumSignals',2);
% [~,ang_est] = step(hdoa,x64);
% figure(4);plotSpectrum(hdoa);
