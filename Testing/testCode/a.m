...
disp('load data')
[x,Fs_ori]=audioread('/home/viblab/Documents/margiasih/OMP/omp-master/data rekaman/0 derajat/Track 1_001.wav');
...
audiowrite('Track1_001_sparse_noresample2.wav',Xrec,Fs_ori);
