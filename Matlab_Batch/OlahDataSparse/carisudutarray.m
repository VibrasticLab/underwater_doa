...
for i=1:100;
    ...
    name1=sprintf('Track1_044_konv.wav',i);%Sinyal yang ditangkap hidrophone 1
    name2=sprintf('Track2_044_konv.wav',i);%Sinyal yang ditangkap hidrophone 2
    name3=sprintf('Track3_044_konv.wav',i);%Sinyal yang ditangkap hidrophone 3
    name4=sprintf('Track4_044_konv.wav',i);%Sinyal yang ditangkap hidrophone 4
