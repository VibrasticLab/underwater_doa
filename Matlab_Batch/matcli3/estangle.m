function estangle(wavin1,wavin2,wavin3,wavin4,csv_out)
...
fprintf('Proses data TA Margiasih \nEstimasi Waktu Tunda...');
for i=1:100;
    fprintf('%02d%%',floor((i)/(100)*100));

    name1=sprintf(wavin1,i);%Sinyal yang ditangkap hidrophone 1
    name2=sprintf(wavin2',i);%Sinyal yang ditangkap hidrophone 2
    name3=sprintf(wavin3,i);%Sinyal yang ditangkap hidrophone 3
    name4=sprintf(wavin4,i);%Sinyal yang ditangkap hidrophone 4
